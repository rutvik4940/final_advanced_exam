                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.bold,fontFamily: "f3"),
                    ),
                    SizedBox(
                      height: 10,
                    ),
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            ...
                            txtPrice.text =
                                controller.list[index].price! as String;
                        ...
                        IconButton(
                          onPressed: () async {
                            ...
                            controller.cartRead();
                            Get.snackbar("Success","",backgroundColor: Colors.white,animationDuration: Duration(seconds: 1));
                          },
...
//   txtQua.text = m1.qua!;
//   txtPrice.text = m1.price! as String;
//   showDialog(
//     context: context,
//     builder: (context) {
